$(document).ready(function() {
    ...
    $(".chosen-search-input").blur(function() {
        ...
        if (selectedValues.length === 0 && ($(".chosen-search-input").val() === undefined ||$(".chosen-search-input").val() === '' || $(".chosen-search-input").val() === null )) {
    ...
    //Mensaje de Campo Vacio de Apellido Paterno
    ...
    //Mensaje de Campo Vacio para Distribuidor
    ...
    //Mensaje de Campo Vacio para Nombre Producto
    ...
    //Mensahe de Capo Vacio de Cantidad producto
